package com.gaochlei.mulmusic.calendar.component;
...
import com.gaochlei.mulmusic.calendar.view.Week;
...
public class CalendarRenderer {
    ...
    public void onClickDate(int col, int row) {
        Toast.makeText(this.getContext(),"lalal", Toast.LENGTH_SHORT).show();
